...
export default async function IndexPage() {
  ...
  return (
      ...
      <div className="flex mx-auto flex-col px-4 md:px-6 lg:px-8 items-center text-center gap-2">
        <h1 className="text-3xl sm:text-5xl lg:text-7xl font-extrabold leading-tight tracking-tighter md:text-6xl mb-4">
          Sustainable Shipping Reimagined
        </h1>

  

<iframe className="aspect-video max-w-3xl w-full place-self-center overflow-hidden rounded-lg shadow-lg mb-4" src="https://www.youtube.com/embed/rq0lS7ZKYFQ?si=GTgF6H3Rr78LRA2z"></iframe>
        <p className="mt-2 max-w-3xl text-lg text-center text-muted-foreground sm:text-xl">
