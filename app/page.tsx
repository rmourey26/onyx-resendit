...
<iframe className="aspect-video object-fill overflow-hidden rounded-lg shadow-lg space-y-8" src="https://www.youtube.com/embed/rq0lS7ZKYFQ?si=GTgF6H3Rr78LRA2z" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
</div>
