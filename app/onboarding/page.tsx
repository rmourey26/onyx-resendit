    ...
    <>
      ...
      <div className="container relative h-[640px] grid grid-cols-1 flex-col items-center justify-center mx-auto md:grid-cols-2 lg:max-w-none lg:px-0">
        ...
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white md:flex dark:border-r">
          ...
          <Image
          src="https://quantumone.b-cdn.net/onyx/resendit-ob3.jpg"
          width={576}
          height={448}
          alt="Onboarding-three"
          style={{objectFit: "contain"}}
          
        />
          </div>
          <div className="relative z-20 flex items-center text-lg font-medium">
          <svg width="213.772858" height="157.011230" viewBox="0.000000 0.000000 213.772858 157.011230" stroke="none" fill="currentColor" stroke-linecap="round" stroke-linejoin="round" {...props}>
